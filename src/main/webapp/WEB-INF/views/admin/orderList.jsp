        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>${o.orderDate}</td>
                    <%
                        com.XiaoFeng.model.Order o = (com.XiaoFeng.model.Order) pageContext.findAttribute("o");
                        int userId = o.getCustomerId();
                        java.sql.Connection con = (java.sql.Connection) application.getAttribute("con");
                        com.XiaoFeng.dao.UserDao userDao = new com.XiaoFeng.dao.UserDao();
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType = com.XiaoFeng.model.Payment.findByPaymentId(con, n);
                        %>
